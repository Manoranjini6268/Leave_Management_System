/**
 * Icon.js  –  Lightweight inline SVG icon component.
 *
 * Usage:
 *   <Icon name="users" size={20} />
 *   <Icon name="check" size={16} color="#10b981" />
 *
 * All paths are original clean-line icons (24x24 viewBox, 1.5 stroke).
 */
...
const Icon = ({ name, size = 18, color = 'currentColor', className = '', strokeWidth = 1.75 }) => {
